...
tuple<vector<valarray<double>>, vector<string>> P4(vector<function<double(double, unordered_map<string, double>)>> pulses, vector<unordered_map<string, double>> params, vector<string> names, vector<double> alphas, double omega, vector<int> snr_db, int nbits, int M, double truncation = numeric_limits<double>::infinity());
tuple<vector<valarray<double>>, vector<string>> P5(vector<function<double(double, unordered_map<string, double>)>> pulses, vector<unordered_map<string, double>> params, vector<string> names, vector<double> alphas, double omega, int snr_db, vector<int> sir_db, vector<int> L, int nbits, int M, double truncation = numeric_limits<double>::infinity());
tuple<vector<valarray<double>>, vector<string>> P6(vector<function<double(double, unordered_map<string, double>)>> pulses, vector<unordered_map<string, double>> params, vector<string> names, vector<double> alphas, double omega, int snr_db, int sir_db, int L, int nbits, int M, double truncation = numeric_limits<double>::infinity());
